...
>(({ className, type = "text", ...props }, ref) => (
  <input
    ...
    type={type}
    className={cn(
      "h-11 w-full rounded-xl border border-navy-100 bg-white px-4 text-base text-navy-900 placeholder:text-navy-400 transition-colors sm:text-sm",
...
>(({ className, children, ...props }, ref) => (
  <select
    ref={ref}
    className={cn(
      "h-11 w-full appearance-none rounded-xl border border-navy-100 bg-white px-4 pr-9 text-base text-navy-900 transition-colors sm:text-sm",
